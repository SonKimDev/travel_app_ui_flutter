...
import 'package:travel_app_ui_flutter/src/models/onboard_model.dart';
import 'package:travel_app_ui_flutter/src/screens/travel_home_screen.dart';
              ...
              child: Column(
                children: [
                  Row(
                    ...
                    children: [
                      ...List.generate(onboarding.length, (index) => dotIndicator(index))
                    ],
                  ),
                  const SizedBox(height: 20),
                  ClipRRect(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Icon(
                                      Icons.arrow_forward,
                                      color: Colors.white,
                                      size: 24, // Điều chỉnh kích thước cho rõ ràng hơn
                                    ),
                                  ],
                                ),
                              ),
